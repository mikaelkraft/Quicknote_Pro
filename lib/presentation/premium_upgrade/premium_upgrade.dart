  ...
  final List<Map<String, dynamic>> _premiumFeatures = [
    {
      ...
      'description': 'Create unlimited notes without restrictions',
      'icon': 'note',
      'gradient': [Color(0xFF8B5CF6), Color(0xFFA78BFA)],
      'currentLimit': '100 notes max',
    ...
    },
    {
      ...
      'description': 'Export your notes in multiple formats without limits',
      'icon': 'export',
      'gradient': [Color(0xFFEC4899), Color(0xFFF472B6)],
      'currentLimit': '5/month',
      'premiumLimit': 'Unlimited',
      'hasDemo': false,
    },
    {
    ...
    },
    {
      ...
      'currentLimit': 'Standard themes',
      'premiumLimit': 'Custom themes',
      'hasDemo': false,
    },
  ];
