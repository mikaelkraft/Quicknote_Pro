...
import '../presentation/settings_profile/cloud_connections.dart';
...
class AppRoutes {
  ...
  static const String cloudConnections = '/cloud-connections';
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    cloudConnections: (context) => const CloudConnectionsScreen(),
